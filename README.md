...
Что делает: находит залитый многоугольник зоны, снимает искусственные
замыкающие рёбра и заливку, отбрасывает черновики-дубли трассы, а сами
ломаные (основную линию, карманы, отдельные пятна) обводит парой
параллельных линий. Сторона для красной определяется геометрически —
по положению бывшей залитой области. Результат — два объекта-кривые
в том же файле-контейнере (совместимость с версией Corel отправителя).
